...
<head>
    ...
    <link rel="stylesheet" href="home.css?v=<?php echo time(); ?>_STABLE_V1"/>
    <link rel="stylesheet" href="layout.css?v=<?php echo time(); ?>_STABLE_V1"/>
    <link rel="stylesheet" href="announcements.css?v=<?php echo time(); ?>_STABLE_V1"/>
    ...
    <style>
        ...
        .app-layout { position: relative; z-index: 1; background: transparent !important; flex: 1; display: flex; overflow: hidden; min-height: 0; padding-top: 0 !important; height: 100vh; }

        .main-content { flex: 1; height: 100%; position: relative; display: block; overflow-y: auto; padding-top: 70px !important; scroll-padding-top: 70px; }

        /* Override sidebar for overlay layout */
        .side-nav { position: relative !important; top: 0 !important; height: 100% !important; max-height: 100%; padding-top: 70px !important; border-right: none !important; }

        .side-nav-item { color: #fff !important; margin-top: 0 !important; }
    ...
    <script src="theme.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="popup.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="home.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="search-history.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="voice_search.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="icon-replace.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="notifications.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="mobile-search.js?v=<?php echo time(); ?>_STABLE_V1"></script>
    <script src="announcements.js?v=<?php echo time(); ?>_STABLE_V1"></script>
</body>
</html>