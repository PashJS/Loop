...
<head>
    ...
    <link rel="stylesheet" href="home.css?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"/>
    <link rel="stylesheet" href="layout.css?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"/>
    <link rel="stylesheet" href="announcements.css?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"/>
    ...
    <style>
        ...
        .side-nav {
            ...
            max-height: 100%;
            padding-top: 90px !important; /* RESTORED per user feedback */
    ...
    <script src="theme.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="popup.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="home.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="search-history.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="voice_search.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="icon-replace.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="notifications.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="mobile-search.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
    <script src="announcements.js?v=<?php echo time(); ?>_REFRESH_V3_LIVE_FIX_LIVE_FIX"></script>
</body>
</html>
